...
def main():
    ...
    ap.add_argument("--model", required=True, help='HF model repo/path for CLIPModel.from_pretrained(...)')
    ap.add_argument("--processor", required=True, help='HF processor repo/path for CLIPProcessor.from_pretrained(...)')
